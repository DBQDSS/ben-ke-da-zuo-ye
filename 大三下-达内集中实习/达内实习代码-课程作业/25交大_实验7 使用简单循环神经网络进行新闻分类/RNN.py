...
model = SimpleRNN(len(train_dataset.vocab), embedding_dim, hidden_dim, num_classes).to(device)
...
# ================== 绘制图像 ==================
# 修改 x 轴范围，使其与 train_losses 和 valid_losses 的长度一致
...
# 修改 x 轴范围，使其与 valid_accuracies 的长度一致
plt.figure()
