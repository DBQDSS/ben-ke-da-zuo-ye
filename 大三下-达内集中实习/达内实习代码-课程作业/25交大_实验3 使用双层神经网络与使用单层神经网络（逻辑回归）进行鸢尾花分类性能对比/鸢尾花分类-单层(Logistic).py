...
def visualize_model_performance(model, X_test, y_test, original_X_test):
    ...
    plt.close()
    print("混淆矩阵已保存为 confusion_matrix1.jpg")
    ...
    plt.savefig('predicted_feature_pairplot1.jpg', bbox_inches='tight')
    plt.close()
    print("测试集预测结果的特征对图已保存为 predicted_feature_pairplot1.jpg")
