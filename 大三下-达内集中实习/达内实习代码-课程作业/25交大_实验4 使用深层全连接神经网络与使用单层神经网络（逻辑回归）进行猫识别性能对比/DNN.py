...
# 定义3层深度全连接网络
class CatFCN(nn.Module):
    """猫识别全连接网络模型"""

    def __init__(self):
        super(CatFCN, self).__init__()
        # 展平图像
        self.flatten = nn.Flatten()

        # 全连接层
        self.fc1 = nn.Linear(3 * 64 * 64, 1024)  # 输入层到隐藏层1
        self.bn1 = nn.BatchNorm1d(1024)
        self.fc2 = nn.Linear(1024, 512)  # 隐藏层1到隐藏层2
        self.bn2 = nn.BatchNorm1d(512)
        self.fc3 = nn.Linear(512, 1)  # 隐藏层2到输出层
...
def visualize_results(results):
    ...
    plt.tight_layout()
    plt.savefig('Training_Loss2.jpg', dpi=300)
    plt.close()
    ...
    plt.legend(fontsize=10)
    plt.tight_layout()
    plt.savefig('Training_and_Test_Accuracy2.jpg', dpi=300)
    plt.close()

    print("Visualization saved as 'Training_Loss2.jpg' and 'Training_and_Test_Accuracy2.jpg'")
